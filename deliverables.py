...
#sort the orders by winning percentage, lowest first
...
#sort the orders by how close their winning percentages are to 0.5
ord1for50 = sorted(res.keys(), key=lambda x: abs(win_pct(res[x][0]) - 0.5)) #sort orders by 
...
#simulate our best and fairest orders
